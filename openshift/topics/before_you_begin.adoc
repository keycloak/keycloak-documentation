...
=== Initial Setup
The Tutorials in this guide follow on from and assume an OpenShift instance similar to that created by performing https://docs.openshift.com/container-platform/3.11/install/running_install.html[the installation of the OpenShift Container Platform cluster].
