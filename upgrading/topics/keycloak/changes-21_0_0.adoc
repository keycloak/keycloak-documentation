...
The possible workaround is to remove algorithms such as `https://www.w3.org/TR/2002/REC-xmldsig-core-20020212/Overview.html#rsa-sha1` or `https://www.w3.org/TR/2002/REC-xmldsig-core-20020212/Overview.html#dsa-sha1` from the list
