...
* An external database is the supported option and needs to be enabled in the Keycloak custom resource. Only for testing purposes you can disable it. See xref:_external_database[Connecting to an external database].
