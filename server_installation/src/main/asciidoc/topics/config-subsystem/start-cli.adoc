...
To start the {book_appserver_name} CLI, you need to run `jboss-cli`.
...
to setup or enter in a admin username and password.  See the link:{book_appserver_admindoc_link}[_{book_appserver_admindoc_name}_]
