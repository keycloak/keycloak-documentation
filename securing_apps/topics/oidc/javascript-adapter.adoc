...
A good practice is to include the JavaScript adapter in your application using a javascript package manager like npm or yarn. The keycloak-js package is available on the following locations:
