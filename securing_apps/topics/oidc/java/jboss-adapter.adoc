...
To make it easier for you, you can go to the {project_name} Admin Console and go to the Client details of the application this WAR is aligned with, then from _Action_ menu and select the *Download adapter config* option.
