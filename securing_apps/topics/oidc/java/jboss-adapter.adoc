...
To be able to secure WAR apps deployed on {appserver_name}, you must install and configure the
...
include::jboss-adapter-installation-community.adoc[]
endif::[]

ifeval::[{project_product}==true]
include::jboss-adapter-installation-product.adoc[]
endif::[]
