...
ifeval::[{project_product}==true]
. Define a policy for this permission by clicking the *Client details* link
endif::[]
...
ifeval::[{project_product}==true]
.Select Policy Type
image:{project_images}/exchange-target-client-policy-type-selection.png[Client Policy Type Selection]
.Client Policy Creation
...
ifeval::[{project_product}==true]
.Select Policy Type
image:{project_images}/exchange-users-client-policy-selection.png[Client Policy Type Selection]
.Client Policy Creation
image:{project_images}/exchange-users-client-policy.png[Client Policy Creation]
endif::[]
