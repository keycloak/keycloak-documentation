...
opt to use the servlet filter adapter that {book_project_name} has.
...
The {book_project_name} filter has the same configuration parameters available as the other adapters except you must
