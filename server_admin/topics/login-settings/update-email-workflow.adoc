...
[NOTE]
====
If you enable this feature, and you are migrating from previous version, you will need to register `Update Email` required action in your realms. Otherwise, your users won't be able to update their email addresses.
====
