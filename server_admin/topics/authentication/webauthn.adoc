...
. Click *Duplicate*.
. Click on the name to go to the details
. Click on the *🗑️* (trash can icon) of the "WebAuthn Browser Browser - Conditional OTP" and click *Delete*.
...
. Click *+* menu of the *Conditional 2FA* row.
. Click *Add condition*.
