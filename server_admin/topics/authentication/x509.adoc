...
If you use a different attribute name, you may need to add it to the list of read-only attributes. For more detail, see xref:con-read-only-user-attributes_{context}[Threat model mitigation].
