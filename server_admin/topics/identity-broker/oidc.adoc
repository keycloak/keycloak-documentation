...
|Conditional Trust Email
|If enabled and email claim exists together with an email_verified claim set to true, email provided by this provider is not verified even if verification is enabled for the realm.
