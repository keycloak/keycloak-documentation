...
|The way the client will authenticate token url calls to the identity provider. See https://openid.net/specs/openid-connect-core-1_0.html#ClientAuthentication
