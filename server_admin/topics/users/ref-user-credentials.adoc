...
When credentials have been created for this user a table with all the credentials will appear dragging and dropping the rows will shift the priority of the credential for the user.
endif::[]
