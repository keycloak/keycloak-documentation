...
The application can save this offline token in a database or on disk and can use it later even if the user is logged out.
This is useful if your application needs to do some "offline" actions on behalf of the user even when she is not online.
