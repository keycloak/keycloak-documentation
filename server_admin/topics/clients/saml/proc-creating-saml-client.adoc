...
*Signature Algorithm*:: The algorithm used in signing SAML documents. Note that `SHA1` based algorithms are deprecated and can be removed in the future.
...
will not work if the SAML client runs on Java 17 or later.
