...
*Valid post logout redirect URIs*:: Similar like `Valid Redirect URIs`, but those are valid redirect URIs to be used for the redirect to this client after logout. Use value `+` to use same set of URIs
