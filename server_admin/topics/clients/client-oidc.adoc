...
Additionally, it is possible to use regular expressions as valid redirect URIs configurable via the <<_fine_grain_permissions, Fine Grain Admin Permissions>>. Using wildcards is still the recommended way.
