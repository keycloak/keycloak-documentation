...
xref:con-oidc_{context}[OpenID Connect] is the preferred protocol to secure applications.  It was designed from the ground up to be web friendly
...
If this is on, clients are allowed to use the OIDC xref:con-oidc-auth-flows_{context}[Authorization Code Flow].

*Implicit Flow Enabled*

If this is on, clients are allowed to use the OIDC xref:con-oidc-auth-flows_{context}[Implicit Flow].

*Direct Access Grants Enabled*

If this is on, clients are allowed to use the OIDC xref:con-oidc-auth-flows_{context}[Direct Access Grants].
