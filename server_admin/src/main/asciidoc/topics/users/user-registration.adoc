...
You can enable {book_project_name} to allow user self registration.  When enabled, the login page has a registration
...
.Registration Link
image:{book_images}/registration-link.png[]
...
.Registration Form
image:{book_images}/registration-form.png[]
...
See the link:{book_developerguide_link}[{book_developerguide_name}] for more information.
