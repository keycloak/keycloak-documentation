...
image:{book_images}/stack-overflow-add-identity-provider.png[]
...
Finally, you will need to obtain the client ID, secret, and key from this page so you can enter them back on the {book_project_name} `Add identity provider` page.
