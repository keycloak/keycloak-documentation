...
{book_project_name} allows you to define what exactly is transferred.
...
.Mappers Tab
image:{book_images}/mappers-oidc.png[]
...
.Mapper Config
image:{book_images}/mapper-config.png[]
...
Consent Text::
  ...
  localized value is then configured within property files in your theme.  See the link:{book_developerguide_link}[{book_developerguide_name}]
...
.Add Mapper
image:{book_images}/add-mapper.png[]
