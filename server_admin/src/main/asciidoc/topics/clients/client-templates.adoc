...
and <<_client_scope, scope>> for each of these clients.  {book_project_name} allows you to define shared client configuration in an entity called a _client template_.
