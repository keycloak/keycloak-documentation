...
image:{book_images}/x509-execution.png[]
...
image:{book_images}/x509-browser-flow.png[]

#### Configuring X.509 Client Certificate Authentication

image:{book_images}/x509-configuration.png[]
...
image:{book_images}/x509-directgrant-execution.png[]

* Change the `Requirement` to _REQUIRED_.

image:{book_images}/x509-directgrant-flow.png[]
