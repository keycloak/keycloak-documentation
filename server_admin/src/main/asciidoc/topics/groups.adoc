...
Groups in {book_project_name} allow you to manage a common set of attributes and role mappings for a set of users.
...
.User Groups
image:{book_images}/user-groups.png[]
...
.Group Membership
image:{book_images}/group-membership.png[]
