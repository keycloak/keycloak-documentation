...
* Now Gatekeeper provides support to https://cheatsheetseries.owasp.org/cheatsheets/Cross-Site_Request_Forgery_Prevention_Cheat_Sheet.html#samesite-cookie-attribute[Same-site cookies]. Thanks to https://github.com/fiji-flo[fiji-flo]
