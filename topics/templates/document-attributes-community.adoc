...
:adapterguide_kcinit_name: Securing Applications and Services Guide
:adapterguide_kcinit_link: {adapterguide_link}#_kcinit
...
:developerguide_auth_spi_console_name: Authentication SPI
:developerguide_auth_spi_console_link: {developerguide_link}#_auth_spi
