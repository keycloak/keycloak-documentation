...
:project_versionMvn: 9.0.11.redhat-00001
:project_versionNpm: 9.0.10-redhat-00001
:project_images: rhsso-images
:project_name_full: Red Hat Single Sign-On
:ProductName: {project_name_full}
:project_version_base: 7.4.0
:project_version_base_ga: {project_version_base}.GA
:project_version_MMM: 7.4.5
:project_version: {project_version_MMM}.GA
...
//Runtimes component attributes
:component-name: "SSO"
:component-version: {project_version_MMM}
...
:ocpdocs_ingress_service_external_ip_link: {official_ocp_docs_link}/latest/networking/configuring_ingress_cluster_traffic/configuring-ingress-cluster-traffic-service-external-ip.html#nw-service-externalip-create_configuring-ingress-cluster-traffic-service-external-ip
