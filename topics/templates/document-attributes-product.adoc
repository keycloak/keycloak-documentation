...
:project_doc_base_url: https://access.redhat.com/documentation/en-us/red_hat_single_sign-on/{project_version_base}
:project_doc_html_single_url: {project_doc_base_url}/html-single
...
:authorizationguide_link: {project_doc_html_single_url}/authorization_services_guide/
:adapterguide_name: Securing Applications and Services Guide
:adapterguide_link: {project_doc_html_single_url}/securing_applications_and_services_guide/
...
:adminguide_link: {project_doc_html_single_url}/server_administration_guide/
...
:apidocs_link: {project_doc_html_single_url}/api_documentation/index
:developerguide_name: Server Developer Guide
:developerguide_link: {project_doc_html_single_url}/server_developer_guide/
...
:gettingstarted_link: {project_doc_html_single_url}/getting_started_guide/
:upgradingguide_name: Upgrading Guide
:upgradingguide_link: {project_doc_html_single_url}/upgrading_guide/
:releasenotes_name: Release Notes
:releasenotes_link: {project_doc_html_single_url}/release_notes/
:openshift_openjdk_name: Red Hat Single Sign-On for OpenShift on OpenJDK
:openshift_openjdk_link: {project_doc_html_single_url}/red_hat_single_sign-on_for_openshift/
...
:openshift_openj9_link: {project_doc_html_single_url}/red_hat_single_sign-on_for_openshift_on_openj9/
...
:installguide_link: {project_doc_html_single_url}/server_installation_and_configuration_guide/
