...
If you are using Java, you can access the {book_project_name} Authorization Services using the Authorization Client API.
...
+
The base URL of the {book_project_name} server. All other {book_project_name} pages and REST service endpoints are derived from this. It is usually in the form https://host:port/auth.
