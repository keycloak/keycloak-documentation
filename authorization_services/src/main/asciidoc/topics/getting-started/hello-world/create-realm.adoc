...
image:{book_images}/getting-started/hello-world/create-realm.png[alt="Realm hello-world-authz"]
...
+
.Add User
image:{book_images}/getting-started/hello-world/create-user.png[alt="Add User"]

. Set a password for the user by clicking the *Credentials* tab.
+
.Set User Password
image:{book_images}/getting-started/hello-world/reset-user-pwd.png[alt="Set User Password"]
