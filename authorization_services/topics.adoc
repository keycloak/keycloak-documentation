...
include::topics/policy-role-policy-required-role.adoc[leveloffset=+2]
...
include::topics/service-rpt-overview.adoc[leveloffset=+3]

include::topics/service-rpt-token-introspection.adoc[leveloffset=+2]
