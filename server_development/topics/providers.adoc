...
{project_name} Service Provider Interfaces are available as Maven artifacts. Here is a `pom.xml` sample to get you started:
...
If you want to see the list of all available SPIs at runtime, you can check `Server Info` page in admin console as described in <<_providers_admin_console,Admin Console>> section.